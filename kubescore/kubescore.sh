...
run_kubescore="sudo docker run -it -v $(pwd)/${objectDir}:/${objectDir} zegl/kube-score:v1.7.0 score $(ls ${objectDir}/*) -o json"

#echo ${run_kubescore}
${run_kubescore} > $(pwd)/${resultDir}/${resultFile}